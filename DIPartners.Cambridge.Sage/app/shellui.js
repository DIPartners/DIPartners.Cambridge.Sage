...
function OnNewShellUI(shellUI) {
    ...
    console.initialize(shellUI, "APInvoice");
...
function OnNewNormalShellFrame(shellFrame) {
    ...
    function OnStarted() {
        myTab = shellFrame.RightPane.AddTab("Details", "Details", "_last");
    }
    ...
    function IsExactlyOneDocumentSelected(selectedItems) {
        ...
        if (selectedItem.Class != shellFrame.ShellUI.Vault.ClassOperations.GetObjectClassIDByAlias("vClass.Invoice"))
            return false;
    ...
    function ShowDashboard(objectVersion) {
        ...
        myTab.ShowDashboard("APInvoice", { ObjectVersion: objectVersion });
        myTab.Visible = true;
    }
