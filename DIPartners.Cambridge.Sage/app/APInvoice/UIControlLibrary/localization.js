...
function localization() {
	...
	/**
	 * Returns an index of first day of the week. Sunday is 0.
	 *
	 * @return index - Index of first day of the week.
	 */
	this.getFirstDayOfWeek = function() {
		...
		var firstDayOfWeek;
		var firstDayStr = this.getCalendarInfo( "FirstDay" );
		if( firstDayStr == "" ) {
			
			// M-Files doesn't support getting of first day of the week. Use sunday (=0)  as default value.
			firstDayOfWeek = 0;
		}
		else {

			// Convert to "JavaScript" format.
			firstDayOfWeek = parseInt( firstDayStr, 10 );
			if( firstDayOfWeek == 6 )
				firstDayOfWeek = 0;
			else
				firstDayOfWeek++;
	...
	this.strings.IDS_STR_NO_TRANSITION = this.getText( 20531 );
	...
	this.strings.IDS_CONTROLHELPER_DROPDOWN_NO_CHILDREN = this.getText( 28076 );
	this.strings.IDS_CONTROLHELPER_DROPDOWN_FIRST_VALUES = this.getText( 28077 );
	this.strings.IDS_CONTROLHELPER_DROPDOWN_SEARCHING_FIRST_SUGGESTIONS = this.getText( 28078 );
	...
	this.strings.IDS_STR_METADATACARD_SHOW_MORE = this.getText( 27843 );
	this.strings.IDS_STR_METADATACARD_SHOW_LESS = this.getText( 27844 );
	this.strings.IDS_STR_NO_STATE = this.getText( 26234 );
	...
	this.strings.IDS_METADATACARD_ASSIGNEDTO_BUTTON_MARKAPPROVED_TOOLTIP = this.getText(20517);
	this.strings.IDS_METADATACARD_ASSIGNEDTO_BUTTON_MARKREJECTED_TOOLTIP = this.getText(20520);
	...
	this.strings.IDS_HOMESCREEN_ITEM_SOLUTION_CATALOG = this.getText( 27829 );
	this.strings.IDS_HOMESCREEN_ITEM_OVERVIEW_VIDEO_URL = this.getText( 27836 );
	this.strings.IDS_HOMESCREEN_ITEM_GUIDED_TOUR_URL = this.getText( 27837 );
	this.strings.IDS_HOMESCREEN_ITEM_TRAINING_URL = this.getText( 27838 );
	this.strings.IDS_HOMESCREEN_ITEM_TECHNICAL_DOCUMENTATION_URL = this.getText( 27839 );
	this.strings.IDS_HOMESCREEN_ITEM_CONTACT_SUPPORT_URL = this.getText( 27840 );
	this.strings.IDS_VALUE_SUGGESTION_MORE = this.getText( 27882 );
	this.strings.IDS_VALUE_SUGGESTION_LESS = this.getText( 27883 );
	this.strings.IDS_VALUE_SUGGESTION_CANNOT_BE_ADDED = this.getText( 27901 );
	this.strings.IDS_METADATACARD_CONFIGURATION_LOOKUPCONTROL_ITEM_NONE = this.getText( 27904 );
	this.strings.IDS_METADATACARD_CONFIGURATION_BOOLEANCONTROL_ITEM_NOT_KNOWN = this.getText( 27905 );
	this.strings.IDS_METADATACARD_CONFIGURATION_LOOKUPCONTROL_MAX_NUMBER_OF_ITEMS_EXCEEDED = this.getText( 27912 );
	this.strings.IDS_METADATACARD_ADDSUBITEM_BUTTON_TOOLTIP = this.getText( 27913 );
	this.strings.IDS_METADATACARD_CONFIGURATION_LOOKUPCONTROL_NO_VALUE_SELECTED = this.getText( 27915 );
	this.strings.IDS_METADATACARD_OPTION_TOOLTIP_UNPIN = this.getText( 27927 );
	this.strings.IDS_METADATACARD_OPTION_TOOLTIP_PIN = this.getText( 27926 );
	this.strings.IDS_METADATACARD_BUTTON_TOOLTIP_CREATE = this.getText( 27928 );
	this.strings.IDS_METADATACARD_BUTTON_TOOLTIP_SAVE = this.getText( 27929 );
	this.strings.IDS_SEARCHPANE_TITLE = this.getText( 27857 );
	this.strings.IDS_SEARCHPANE_COMMAND_REFINE_SEARCH = this.getText( 27858 );
	this.strings.IDS_SEARCHPANE_LINK_SHOW_MORE = this.getText( 27859 );
	this.strings.IDS_SEARCHPANE_LINK_SHOW_LESS = this.getText( 27860 );
	this.strings.IDS_SEARCHPANE_NO_REFINEMENT_OPTIONS_AVAILABLE = this.getText( 27878 );
	this.strings.IDS_STR_FILTER_EXPR_OBJECT_TYPE = this.getText( 26229 );
	this.strings.IDS_STR_FILTER_EXPR_FILE_EXTENSION = this.getText( 27863 );
	this.strings.IDS_METADATACARD_BUTTON_ANALYZE = this.getText( 27930 );
	this.strings.IDS_METADATACARD_BUTTON_ANALYZING = this.getText( 27931 );
	this.strings.IDS_METADATACARD_BUTTON_TOOLTIP_ANALYZE = this.getText( 27932 );
	this.strings.IDS_METADATACARD_ANALYSIS_COMPLETE = this.getText( 27933 );
	this.strings.IDS_METADATACARD_ANALYSIS_NO_SUGGESTIONS = this.getText( 27934 );
	this.strings.IDS_STR_SEE_EVENT_LOG_FOR_DETAILS = this.getText( 5110 );

	// Advanced Search Dashboard Strings.
	this.strings.IDS_ADVSEARCH_SECTION_SEARCH_SCOPES = this.getText( 20677 );
	this.strings.IDS_ADVSEARCH_SECTION_SEARCH_FILTERS = this.getText( 20679 );
	this.strings.IDS_ADVSEARCH_INVALID_ITEM_TEXT = this.getText( 20702 );
	this.strings.IDS_ADVSEARCH_MIN_VALUES = this.getText( 20703 );
	this.strings.IDS_ADVSEARCH_SEARCHING_PLACEHOLDER = this.getText( 20704 );
	this.strings.IDS_SEARCHPANE_LINK_SHOW_MORE = this.getText( 27859 );
	this.strings.IDS_SEARCHPANE_LINK_SHOW_LESS = this.getText( 27860 );
	this.strings.IDS_SEARCHPANE_VIEW_FILTER = this.getText( 20707 );
	this.strings.IDS_SEARCHPANE_FTS_SCOPE_FILTER = this.getText( 20708 );
	this.strings.IDS_SEARCHPANE_OBJECT_TYPE_FILTER = this.getText( 20709 );
	this.strings.IDS_SEARCHPANE_REPOSITORY_FILTER = this.getText( 20710 );
	this.strings.IDS_SEARCHPANE_SEARCH_FILTERS_TITLE = this.getText( 20711 );
};
