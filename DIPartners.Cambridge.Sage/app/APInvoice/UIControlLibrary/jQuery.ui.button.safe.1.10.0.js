// Override the JQuery UI Button ( version 1.10.0 ) widgets reset button logic, to ensure the label text is html encoded before rendering.
( function (
	$,
	undefined ) {
			...
			$.ui.button.prototype,
			{
				_create: function() {
					...
					if ( options.label === null ) {
						options.label = (this.type === "input" ? this.buttonElement.val() : this.buttonElement.text());
					}
				...
				_destroy: function() {
					...
					this.buttonElement
						...
						.text( this.buttonElement.find(".ui-button-text").text() );
